...
public class Commend_fragment extends Fragment implements View.OnClickListener{
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.commend_button_1:   goalBeanList.add(new GoalBean(new Random(System.currentTimeMillis()).nextInt(),"早睡早起","365","2017-06-26","", resourceIdToUri(getActivity().getApplicationContext(), R.drawable.bg_1).toString(),"设置闹钟",0, false));
                Toast.makeText(getContext(),"添加成功",Toast.LENGTH_SHORT).show();
            case R.id.commend_button_2:  Toast.makeText(getContext(),"添加成功",Toast.LENGTH_SHORT).show();goalBeanList.add(new GoalBean(new Random(System.currentTimeMillis()).nextInt() , "坚持学习","365","2018-07-22","学习永无止境",resourceIdToUri(getActivity().getApplicationContext(),R.drawable.bg_2).toString(),"设置闹钟",0, false));break;
